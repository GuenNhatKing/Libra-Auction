...
const statusConfig: Record<AuctionStatus, { label: string, classes: string }> = {
    UPCOMING: { label: 'Sắp diễn ra', classes: 'bg-amber-50 text-amber-600 border-amber-100' },
    LIVE: { label: 'Đang diễn ra', classes: 'bg-green-50 text-green-600 border-green-100' },
    ENDED: { label: 'Đã kết thúc', classes: 'bg-gray-50 text-gray-500 border-gray-100' },
    CANCELLED: { label: 'Đã hủy', classes: 'bg-red-50 text-red-600 border-red-100' },
};
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-1">
                        ...
                        <span className="flex items-center gap-1 text-sm font-medium text-[var(--secondary-color)]">
